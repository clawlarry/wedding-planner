  ...
  return (
    <div className="space-y-6 md:space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <Link
          href="/venues/new"
          className="bg-rose-600 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 hover:bg-rose-700 text-sm md:text-base"
        >
          Add Venue
        </Link>
      </div>
            ...
            {venues.map((venue) => (
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2">
                  ...
                  <span className={`px-3 py-1 rounded-full text-xs md:text-sm self-start ${
