        ...
        {guests.length === 0 ? (
          ...
          <div className="space-y-2">
            {guests.map((guest) => (
              <div
                key={guest.id}
                className="flex items-center justify-between p-3 md:p-4 border rounded-lg hover:bg-gray-50 gap-3"
              >
                ...
                <span className={`px-2 py-1 md:px-3 rounded text-xs md:text-sm flex-shrink-0 ${
